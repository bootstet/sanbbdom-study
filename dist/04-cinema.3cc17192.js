...
},{}],"src/04-cinema.js":[function(require,module,exports) {
"use strict";
...
var vnode = (0, _snabbdom.h)('div', [contentRender(), moveviews()]); // 排序
...
function remove(item) {
  originalData = originalData.filter(function (m) {
    return m !== item;
  });
  vnode = patch(vnode, render());
} // 添加dom
...
function add() {
  ...
  originalData.unshift(_objectSpread(_objectSpread({}, n), {}, {
    rank: nextKey++
  }));
  vnode = patch(vnode, render());
} // 顶部header渲染
...
function contentRender() {
  return (0, _snabbdom.h)('div#content', [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('div#header', {
    style: {}
  }, [(0, _snabbdom.h)('span', {
    style: {
      marginRight: '10px'
    }
  }, 'Sort by:'), (0, _snabbdom.h)('span', {
    style: {
      marginRight: '10px'
    },
    on: {
  ...
  }, 'Title'), (0, _snabbdom.h)('span', {
    on: {
      click: [sortBy, 'desc']
    }
  }, 'Description'), (0, _snabbdom.h)('span', {
    style: {
      float: "right"
    },
    on: {
...
function render() {
  return (0, _snabbdom.h)('div', [contentRender(), moveviews()]);
}

function moveviews() {
  return (0, _snabbdom.h)('div#movies-list', {
    style: {
      marginTop: '10px'
    }
    ...
    }, item.rank), (0, _snabbdom.h)('div', item.title), (0, _snabbdom.h)('div', item.desc), (0, _snabbdom.h)('div.btn.rm-btn', {
      on: {
        click: [remove, item]
      }
    }, 'x')]);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/04-cinema.js"], null)
//# sourceMappingURL=/04-cinema.3cc17192.js.map